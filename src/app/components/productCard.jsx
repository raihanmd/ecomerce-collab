...
import { Flex, Circle, Box, Image, Badge, Icon, chakra, Tooltip } from "@chakra-ui/react";
...
function ProductCard() {
  return (
    <Flex p={50} w={"full"} alignItems="center" justifyContent="center">
      <Box bg={"white"} maxW="sm" borderWidth="1px" rounded="lg" shadow="lg" position="relative">
